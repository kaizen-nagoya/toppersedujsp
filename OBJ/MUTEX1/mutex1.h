 ...
 * 
 *  @(#) $Id: mutex1.h,v 1.1 2004/03/01 11:15:24 roi Exp $
 */
 ...
 *  タイマープロセスの時間設定
 */
#define	T_TICK1		200		/* 実行周期 200ms */
#define	T_TICK2		320		/* 実行周期 320ms */
...
extern void display_task(VP_INT exinf);
